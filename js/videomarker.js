    ...
    function d(b) {
        ...
        function f(b) {
            a.each(b, function(a, b) {
                b.key = c(), t.find(".vjs-progress-control").append(h(b)), r[b.key] = b, s.push(b)
            }), d()
        }
        ...
        function h(b) {
            ...
            return c.css(q.markerStyle).css({
                "margin-left": -parseFloat(c.css("width")) / 2 + "px",
                left: g(b) + "%"
            }).attr("data-marker-key", b.key).attr("data-marker-time", q.markerTip.time(b)), b["class"] && c.addClass(b["class"]), c.on("click", function() {
                var c = !1;
                if ("function" == typeof q.onMarkerClick && (c = 0 == q.onMarkerClick(b)), !c) {
                    var d = a(this).data("marker-key");
                    v.currentTime(q.markerTip.time(r[d]))
                }
            }), q.markerTip.display && k(c), c
        }
        ...
        function i() {
            for (var a = 0; a < s.length; a++) {
                ...
                c.data("marker-time") != e && c.css({
                    left: g(b) + "%"
                }).attr("data-marker-time", e)
            }
            d()
        }
        ...
        function j(a) {
            ...
            for (var b = 0; b < a.length; b++) {
                var c = a[b],
                    e = s[c];
                e && (delete r[e.key], s[c] = null, t.find(".vjs-marker[data-marker-key='" + e.key + "']").remove())
            }
        ...
        function k(b) {
            b.on("mouseover", function() {
                ...
                w.find(".vjs-tip-inner").text(q.markerTip.text(b)), w.css({
                    left: g(b) + "%",
        ...
        function l() {
            w = a("<div class='vjs-tip'><div class='vjs-tip-arrow'></div><div class='vjs-tip-inner'></div></div>"), t.find(".vjs-progress-control").append(w)
        }
        ...
        function m(a) {
            if (!(0 > u)) {
                ...
                a >= c && a <= c + q.breakOverlay.displayTime ? (y != u && (y = u, x.find(".vjs-break-overlay-text").text(q.breakOverlay.text(b))), x.css("visibility", "visible")) : (y = -1, x.css("visibility", "hidden"))
            }
        }

        function n() {
            x = a("<div class='vjs-break-overlay'><div class='vjs-break-overlay-text'></div></div>").css(q.breakOverlay.style), t.append(x), y = -1
        }
            ...
            if (s.length > 0 && d < q.markerTip.time(s[0])) a = -1;
                ...
                for (var f = 0; f < s.length; f++)
                    if (e = c(f), d >= q.markerTip.time(s[f]) && e > d) {
                        a = f;
                        break
                    } a != u && (-1 != a && b.onMarkerReached && b.onMarkerReached(s[a]), u = a), q.breakOverlay.display && m(d)
        }

        function p() {
            q.markerTip.display && l(), v.markers.removeAll(), f(b.markers), q.breakOverlay.display && n(), o(), v.on("timeupdate", o)
        }
        ...
        v.on("loadedmetadata", function() {
            ...
            destroy: function() {
                v.markers.removeAll(), x.remove(), w.remove(), v.off("timeupdate", m), delete v.markers
            }
        }
    }
    var e = {
